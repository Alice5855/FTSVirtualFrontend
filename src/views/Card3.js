    ...
    return(
            <div className="px-3 py-5 my-5 text-center rounded-5" style={{backgroundColor: "#50A0F4"}}>
                ...
                <div className="col-lg-12 mx-auto">
                    <p className="my-5">
                        <a href="https://www.youtube.com/c/ksonONAIR" target={'_blank'} rel="noreferrer">
                        ...
                        <a href="https://www.youtube.com/channel/UCx6h43OXFM7OuER4iJqWaSg" target={'_blank'} rel="noreferrer">
                            <span className="secretLink" style={{display: 'inline-block', width: '40px', height: '40px'}} />
                        </a>
