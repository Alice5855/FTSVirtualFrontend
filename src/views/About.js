                ...
                <div>
                        ...
                        <div class="container col-xxl-8 px-4 py-5">
                            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                                <div class="col-10 col-sm-8 col-lg-6">
                                    <img src="http://localhost:3000/images/bak1.jpg" className="rounded d-block mx-lg-auto img-fluid" alt="Introduce" width="700" height="500" loading="lazy" />
                                </div>
                                <div class="col-lg-6">
                    ...
                    <div>
                        <div class="container col-xxl-8 px-4 py-5">
                            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                                <div class="col-10 col-sm-8 col-lg-6">
                                    <img src="http://localhost:3000/images/bak2.jpg" className="rounded d-block mx-lg-auto img-fluid" alt="Introduce" width="800" height="600" loading="lazy" />
                                </div>
                                <div class="col-lg-6">
                    ...
                    <div>
                        <div class="container col-xxl-8 px-4 py-5">
                            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                                <div class="col-10 col-sm-8 col-lg-6">
                                    <img src="http://localhost:3000/images/bak3.jpg" className="rounded d-block mx-lg-auto img-fluid" alt="Introduce" width="800" height="600" loading="lazy" />
                                </div>
                                <div class="col-lg-6">
